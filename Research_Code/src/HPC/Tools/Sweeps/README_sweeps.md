...
bash Research_Code/src/HPC/Tools/Sweeps/submit_sweep.sh \
    Research_Code/src/HPC/Tools/Sweeps/example_rom_sweep.txt
```
...
```bash
DRY_RUN=true bash Research_Code/src/HPC/Tools/Sweeps/submit_sweep.sh \
    Research_Code/src/HPC/Tools/Sweeps/example_rom_sweep.txt
```
...
```bash
python3 Research_Code/src/HPC/Tools/Sweeps/sweep_params.py env \
    Research_Code/src/HPC/Tools/Sweeps/example_rom_sweep.txt 0
```
...
```bash
REPO_ROOT="$PWD" \
SWEEP_FILE=Research_Code/src/HPC/Tools/Sweeps/example_rom_sweep.txt \
