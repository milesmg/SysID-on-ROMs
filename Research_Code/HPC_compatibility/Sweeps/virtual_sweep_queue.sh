...
usage() {
    cat <<EOF
Usage:
  bash Research_Code/HPC_compatibility/Sweeps/virtual_sweep_queue.sh <sweep_file.txt> [more_sweeps...]
  bash Research_Code/HPC_compatibility/Sweeps/virtual_sweep_queue.sh status
  bash Research_Code/HPC_compatibility/Sweeps/virtual_sweep_queue.sh stop
