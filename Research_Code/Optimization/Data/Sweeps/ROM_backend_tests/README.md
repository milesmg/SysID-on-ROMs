...
rsync -av \
  ...
  Research_Code/Optimization/Data/Sweeps/ROM_backend_tests/ \
  hpc1:/home/mgantcher/Brookhaven/Research_Code/Optimization/Data/Sweeps/ROM_backend_tests/
...
bash Research_Code/HPC_compatibility/Sweeps/submit_sweep.sh \
  Research_Code/Optimization/Data/Sweeps/ROM_backend_tests/00_mooncake_rom_backend_smoke.txt
```
...
```bash
REPO_ROOT="$PWD" \
SWEEP_FILE=Research_Code/Optimization/Data/Sweeps/ROM_backend_tests/00_mooncake_rom_backend_smoke.txt \
SWEEP_TOTAL_COUNT=8 \
